from m00_common.parser import SourceHandler, is_alpha, is_digit, is_white, CalculatorSyntaxError
...
class AbstractParser:
    ...
    def _raise_error_expected(self, name: str) -> None:
        ...
        :param name: Name of the expected token
        """
        raise CalculatorSyntaxError(self.src, f'{name} expected, but {self.look} found')
