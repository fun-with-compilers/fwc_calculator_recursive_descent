...
from . import AbstractParser, source_from_string, CalculatorSyntaxError


def parser_from_string(src: str) -> AbstractParser:
    src_handler = source_from_string(src)
    parser = AbstractParser(src_handler)
    return parser
...
class AbstractParserReadTokensTest(unittest.TestCase):
    ...
    def test_non_number(self):
        ...
        self.assertRaises(CalculatorSyntaxError, parser.read_number)
    ...
    def test_non_identifier(self):
        parser = parser_from_string('1985')
        self.assertRaises(CalculatorSyntaxError, parser.read_identifier)
...
class AbstractParserExpectFunctionTest(unittest.TestCase):
    ...
    def test_unexpected_fn(self):
        self.assertRaises(CalculatorSyntaxError, lambda: AbstractParserExpectFunctionTest._expect('a+b'))
...
class AbstractParserExpectChTest(unittest.TestCase):
    ...
    def test_unexpected_ch(self):
        self.assertRaises(CalculatorSyntaxError, lambda: AbstractParserExpectChTest._expect('a+b'))
...
class AbstractParserExpectStrTest(unittest.TestCase):
    ...
    def test_unexpected_prefix_str(self):
        parser = parser_from_string('apple tree')
        self.assertRaises(CalculatorSyntaxError, lambda: parser.expect_str('xmas tree'))

    def test_unexpected_sub_str(self):
        parser = parser_from_string('apple tree')
        self.assertRaises(CalculatorSyntaxError, lambda: parser.expect_str('apple juice'))
